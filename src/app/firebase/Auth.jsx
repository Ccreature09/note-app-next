...
export const GoogleAuthButton = () => {
  ...
  return (
    <button className='mb-4 border-none bg-green-500 p-2 text-2xl rounded  text-[#F1FAEE]' onClick={handleAuthClick}>
...
export const GuestAuthButton = () => {
  ...
  return (
    <button className='mb-4 border-none bg-gray-500 p-2 rounded text-2xl text-[#F1FAEE]' onClick={handleAuthClick}>
